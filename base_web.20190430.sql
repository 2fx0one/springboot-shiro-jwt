...
CREATE TABLE `sys_menu` (
  ...
  `parent_id` varchar(64) NOT NULL COMMENT '父级编号',
  `parent_ids` varchar(2000) DEFAULT '' COMMENT '所有父级编号',
  `name` varchar(100) NOT NULL DEFAULT 'name' COMMENT '名称',
...
-- Dump completed on 2019-04-30 17:25:08
