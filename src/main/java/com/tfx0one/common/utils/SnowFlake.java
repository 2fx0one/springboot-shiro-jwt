...
public class SnowFlake {
	// 时间起始标记点，作为基准，一般取系统的最近时间（一旦确定不能变动） Fri Oct 11 11:41:46 CST 2019
	private final static long START_STMP = 1570765306817L;
	// 机器标识位数
	...
	public synchronized long nextId() {
		...
		// ID偏移组合生成最终的ID，并返回ID
		long nextId = ((timestamp - START_STMP) << TIMESTAMP_LEFT_SHIFT)
	...
	public static void main(String[] args) {
		System.out.println("new SnowFlake().nextId() = " + new SnowFlake().nextId());
	}
